...
def n_adx(bars: pd.DataFrame, window: int):
    high, low, close = bars['high'], bars['low'], bars['close']
    tr_smooth = bars['_tr_smooth']
    smooth_directional_movement_plus = bars['_smooth_directional_movement_plus']
    smooth_neg_movement = bars['_smooth_neg_movement']
